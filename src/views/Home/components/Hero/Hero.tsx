    ...
    <Box data-aos={isMd ? 'fade-right' : 'fade-up'}>
      <Box marginBottom={2}>
        ...
        <Typography variant="h3" color="text.primary" sx={{ fontWeight: 700 }}>
          Fancy a dance festival?
        </Typography>
      </Box>
      <Box marginBottom={3}>
        <Typography variant="h6" component="p" color="text.secondary">
          We are the most comprehensive calendar for dance events worldwide. Choose your fiesta with us today.
        </Typography>
      </Box>
      <Box display="flex" flexDirection={'column'} justifyContent={'center'}>
        <Box marginBottom={2}>
          <Typography variant="body1" component="p">
            Join our newsletter and keep updated with dance events
          </Typography>
        </Box>
        <Box
          component={'form'}
